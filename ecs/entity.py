""":mod:`ecs.entity` -- Definitions for the Entity and EntityManager types.
"""
...
class EntityManager(object):
    ...
    def add_component(self, entity_id, component_instance):
        ...
        entity_id. ``entity_id`` can be an Entity object or a plain integer.
        """
    ...
    def component_for_entity(self, entity_id, component_type):
        """Returns the instance of component_type for the entity_id from the
        database. Returns None if the entity does not have that component.
        """
        try:
    ...
    def delete_entity(self, entity_id):
        ...
        entity_id, with the side-effect that the entity is also no longer in
        the database.
        """
